        ...
        <div className="w-screen max-w-md bg-slate-100 dark:bg-slate-900/50 dark:bg-slate-900 border-l border-slate-200 dark:border-slate-800 flex flex-col shadow-2xl">
          ...
          <div className="px-6 py-5 border-b border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-900/50 backdrop-blur-md flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100">Recommendation History</h2>
                <p className="text-xs text-slate-600 dark:text-slate-400">Past strategic insights generated by EVE agents</p>
              </div>
            </div>
            <button
              onClick={onClose}
              className="text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200 transition-colors p-1 hover:bg-slate-200 dark:bg-slate-800 rounded-md"
            >
              <X size={18} />
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4">
            {loading ? (
              ...
              <div className="text-center py-12 text-slate-500 dark:text-slate-400 border border-dashed border-slate-200 dark:border-slate-800 rounded-xl p-6">
              ...
              recommendations.map((item) => {
                ...
                return (
                  <div 
                    key={item.id} 
                    className="bg-slate-50 dark:bg-slate-900/80 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 rounded-xl p-4 hover:border-slate-300 dark:border-slate-700 transition-all flex flex-col gap-3"
                  >
                    {/* Source and Time */}
                    ...
                    {/* Confidence gauge */}
                    <div className="flex items-center justify-between text-xs pt-1 border-t border-slate-200 dark:border-slate-800/40">
                      <div className="flex items-center gap-1.5 text-slate-600 dark:text-slate-400">
                        <Award size={13} className="text-indigo-400" />
                        <span>Confidence:</span>
                        <span className="font-semibold text-slate-800 dark:text-slate-200">{confidence}%</span>
                      </div>
                      <button
                    ...
                    {/* Expanded details */}
                    {isExpanded && (
                      <div className="space-y-3 pt-3 border-t border-slate-200 dark:border-slate-800/40 animate-in fade-in slide-in-from-top-1 duration-150">
                        {/* Data Used */}
                        {item.data_used && item.data_used.length > 0 && (
                          <div>
                            ...
                            <ul className="list-disc list-inside text-xs text-slate-600 dark:text-slate-400 mt-1 pl-1 space-y-0.5">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          {item.risk_factors && item.risk_factors.length > 0 && (
                            <div>
                              ...
                              <ul className="text-[11px] text-slate-600 dark:text-slate-400 mt-1 list-disc list-inside space-y-0.5 pl-1">
