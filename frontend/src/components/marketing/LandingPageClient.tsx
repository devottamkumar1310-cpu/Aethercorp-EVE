  ...
  const faqs = [
    {
      ...
      a: "Yes. Export your products from Shopify admin and upload the CSV unchanged — EVE reads Shopify's native export format, including grouped variant rows, size and colour options, and cost-per-item. You do not need to rename a single column.",
    },
    {
      q: "Do I have to book a demo or talk to sales first?",
      a: "No. EVE is self-serve from end to end: sign in with Google, land in a live workspace, upload your Shopify export, and read your first insight — usually inside two minutes.",
    },
    {
    ...
    },
    {
      ...
      a: "EVE is built specifically for fashion and D2C brands, so it forecasts at variant level — size and colour — rather than treating a style as one SKU. That prevents surprise stockouts on key sizes while dead stock builds up in others.",
    },
    {
      q: "What does EVE cost?",
      a: "EVE has three plans, each with full inventory intelligence — the difference is store count, catalogue size, and channel access. Every plan starts with a 14-day free trial, no credit card required.",
    },
    {
      q: "Is my inventory data safe?",
      a: "Yes. EVE's AI has read-only access — it analyses your data and never writes back to your store. Files are stored in encrypted buckets with strict tenant workspace boundaries.",
    },
    {
  ...
  return (
    <div className="landing-page min-h-screen bg-background text-foreground flex flex-col font-sans transition-colors duration-200">
      ...
      <header className="w-full border-b border-border/60 bg-background/80 backdrop-blur-md sticky top-0 z-50 transition-colors">
          ...
          <Link href="/" className="flex items-center gap-3 rounded-xl" aria-label="EVE home">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-muted-foreground font-medium hidden sm:inline">
                AI Inventory Intelligence for Shopify &amp; D2C Brands
              </span>
            </div>
          </Link>

          <nav aria-label="Primary" className="hidden md:flex items-center gap-6 text-xs font-semibold text-muted-foreground">
            <a href="#features" className="hover:text-foreground transition-colors">Capabilities</a>
            <Link href="/inventory-intelligence" className="hover:text-foreground transition-colors">Solutions</Link>
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <Link href="/inventory-intelligence" onClick={() => setMobileMenuOpen(false)} className="text-sm font-semibold text-muted-foreground hover:text-foreground py-1">Solutions</Link>
            <Link href="/resources" onClick={() => setMobileMenuOpen(false)} className="text-sm font-semibold text-muted-foreground hover:text-foreground py-1">Resources</Link>
            <Link href="/glossary" onClick={() => setMobileMenuOpen(false)} className="text-sm font-semibold text-muted-foreground hover:text-foreground py-1">Glossary</Link>
      ...
      <main id="main">
        ...
        <section className="relative overflow-hidden pt-16 pb-20 sm:pt-24 sm:pb-28 flex flex-col items-center text-center px-4 sm:px-6">
          ...
          <div className="max-w-4xl space-y-6 sm:space-y-8 relative z-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              EVE is the AI inventory intelligence platform for Shopify &amp; D2C brands. Predict stockouts before they happen, surface cash trapped in dead stock, and get variant-level reorder recommendations in under two minutes.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  I&apos;m building EVE with a small group of fashion &amp; D2C founders, one catalogue at a time. If you upload your data and EVE tells you something useless, I want to hear it directly — I answer every email myself.
                </p>
        ...
        {/* Interactive Live Product Preview Shell */}
        ...
        {/* The Diagnosis — Core Inventory Problems */}
          ...
          <div className="max-w-7xl mx-auto space-y-12">
            ...
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div className="p-6 rounded-2xl border border-border bg-card shadow-sm space-y-4">
                ...
                <h3 className="text-base font-bold text-foreground">Trapped Cash in Dead Stock</h3>
                <p className="text-xs text-muted-foreground leading-relaxed">
        ...
        <section id="workflow" className="py-16 sm:py-24 px-4 sm:px-6 bg-muted/20 border-y border-border/60">
          <div className="max-w-7xl mx-auto space-y-12">
            <div className="text-center space-y-3">
              ...
              <p className="text-sm text-muted-foreground max-w-xl mx-auto">
                The whole path from this page to a real recommendation about your own catalogue — nothing here waits on us.
              </p>
            </div>
      ...
      {/* Structured Footer with Keyword Authority & Topic Pages */}
      <footer className="w-full bg-background border-t border-border px-4 sm:px-6 py-12">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-8 text-xs mb-12">
          <div className="col-span-2 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-extrabold text-foreground text-sm">{POSITIONING.name}</span>
            </div>
          ...
          <div className="space-y-3">
            <span className="font-bold text-foreground uppercase tracking-wider block">Solutions</span>
            <ul className="space-y-2 text-muted-foreground font-medium">
              <li><Link href="/inventory-intelligence" className="hover:text-foreground transition-colors">Inventory Intelligence</Link></li>
              <li><Link href="/shopify-inventory-management" className="hover:text-foreground transition-colors">Shopify Inventory Management</Link></li>
              <li><Link href="/shopify-inventory-forecasting" className="hover:text-foreground transition-colors">Shopify Forecasting</Link></li>
              <li><Link href="/d2c-inventory-management" className="hover:text-foreground transition-colors">D2C Inventory Management</Link></li>
              <li><Link href="/fashion-inventory-management" className="hover:text-foreground transition-colors">Fashion Inventory</Link></li>
              <li><Link href="/stockout-prediction" className="hover:text-foreground transition-colors">Stockout Prediction</Link></li>
              <li><Link href="/dead-stock-management" className="hover:text-foreground transition-colors">Dead Stock Management</Link></li>
            </ul>
          </div>

          <div className="space-y-3">
            <span className="font-bold text-foreground uppercase tracking-wider block">Resources</span>
            <ul className="space-y-2 text-muted-foreground font-medium">
              ...
              <li><Link href="/vs" className="hover:text-foreground transition-colors">Software Comparisons</Link></li>
          ...
          <div className="space-y-3">
            <span className="font-bold text-foreground uppercase tracking-wider block">Company &amp; Legal</span>
            <ul className="space-y-2 text-muted-foreground font-medium">
        ...
        <div className="max-w-7xl mx-auto border-t border-border/60 pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-muted-foreground gap-4">
          ...
          <div>Support: <a href={`mailto:${POSITIONING.supportEmail}`} className="text-foreground hover:underline">{POSITIONING.supportEmail}</a></div>
        </div>
      </footer>
    </div>
  );
