      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <div className="pt-4 flex justify-end gap-2">
            ...
            <button type="submit" className="px-4 py-2 text-white bg-green-600 hover:bg-green-700 rounded-md transition-colors flex items-center gap-2" disabled={isSubmitting || projects.length === 0}>
