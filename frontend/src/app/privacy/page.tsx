    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans">
      <header className="w-full bg-slate-900/50 backdrop-blur-md border-b border-slate-800 px-6 py-4 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-semibold tracking-tight text-white">Privacy Policy</span>
        </div>
        <Link 
          href="/signup" 
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl space-y-8">
          ...
          <div className="space-y-6 text-slate-300 leading-relaxed">
            ...
            <section className="space-y-3">
              ...
              <p className="font-medium text-slate-200">a. Personal Information</p>
              <p>
              ...
              <p className="font-medium text-slate-200">b. Business and Inventory Data</p>
              <p>
              ...
              <p className="font-medium text-slate-200">c. Usage Data & Cookies</p>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-white">3. Third-Party Services & AI Processing</h2>
              <p>
