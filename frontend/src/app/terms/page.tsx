...
export default function TermsOfServicePage() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans">
      <header className="w-full bg-slate-900/50 backdrop-blur-md border-b border-slate-800 px-6 py-4 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-semibold tracking-tight text-white">Terms of Service</span>
        </div>
        <Link 
          href="/signup" 
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl space-y-8">
          <div className="flex items-center gap-3 border-b border-slate-800 pb-6">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1">Effective Date: June 23, 2026</p>
            </div>
          </div>
          ...
          <div className="space-y-6 text-slate-300 leading-relaxed">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-white">2. Purpose and Scope of Services</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-white">3. User Responsibilities & Data Authorization</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-white">4. AI-Generated Recommendations Disclaimer</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-white">5. Account Termination & Deletion</h2>
              <p>
