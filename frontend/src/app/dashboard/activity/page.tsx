  ...
  return (
    <div className="max-w-[1600px] mx-auto p-6 md:p-8 space-y-8 transition-colors duration-200">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Everything that has happened across your workspace.</p>
      </div>
                ...
                <div key={log.id} className="flex gap-4 items-start pb-6 border-b border-border/60 last:border-0 last:pb-0">
                  ...
                  <div className="space-y-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2 mb-1.5">
                      <span className="text-[10px] font-bold uppercase bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border border-indigo-500/20 px-2 py-0.5 rounded-full tracking-wider">
                    ...
                    <p className="text-muted-foreground text-[10px] mt-2 font-medium">{new Date(log.created_at).toLocaleString()}</p>
                  </div>
                </div>
              );
            })}
